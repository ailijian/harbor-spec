...
|---|---|---|---|---|---|
| harbor.adapters.base.ContractSource.to_dict | harbor/adapters/base.py | JSON serialization | public | strict | JSON serialization, strict target, public surface |
| harbor.adapters.base.ContractSubject.to_dict | harbor/adapters/base.py | JSON serialization | public | strict | JSON serialization, strict target, public surface |
...
| harbor.adapters.base.ContractSource.to_dict | harbor/adapters/base.py | public | strict | ❌ Missing | Missing DDT, strict target, public surface |
| harbor.adapters.base.ContractSubject.to_dict | harbor/adapters/base.py | public | strict | ❌ Missing | Missing DDT, strict target, public surface |
...
|---|---|---|---|---|---|
| harbor.adapters.registry.AdapterRegistry.__init__ | harbor/adapters/registry.py | unknown | unknown | ⚪ Missing | — |
...
| harbor.adapters.base.ContractSource.__post_init__ | harbor/adapters/base.py | unknown | unknown | ⚪ Missing | — |
...
| harbor.adapters.registry.AdapterRegistry._read_enabled_flag | harbor/adapters/registry.py | unknown | unknown | ⚪ Missing | — |
| harbor.adapters.registry.AdapterRegistry._read_language_config | harbor/adapters/registry.py | unknown | unknown | ⚪ Missing | — |
| harbor.adapters.registry.AdapterRegistry._read_languages_config | harbor/adapters/registry.py | unknown | unknown | ⚪ Missing | — |
...
| harbor.adapters.base.ContractSource.compute_fingerprint | harbor/adapters/base.py | unknown | unknown | ⚪ Missing | — |
...
| harbor.adapters.registry.AdapterRegistry.default | harbor/adapters/registry.py | unknown | unknown | ⚪ Missing | — |
| harbor.adapters.base.LanguageAdapter.discover_files | harbor/adapters/base.py | unknown | unknown | ⚪ Missing | — |
...
| harbor.adapters.registry.AdapterRegistry.from_config | harbor/adapters/registry.py | unknown | unknown | ⚪ Missing | — |
| harbor.adapters.python.compat.function_contract_to_subject | harbor/adapters/python/compat.py | unknown | unknown | ⚪ Missing | — |
| harbor.adapters.registry.AdapterRegistry.get_adapter | harbor/adapters/registry.py | unknown | unknown | ⚪ Missing | — |
| harbor.adapters.registry.AdapterRegistry.get_adapters | harbor/adapters/registry.py | unknown | unknown | ⚪ Missing | — |
| harbor.adapters.registry.AdapterRegistry.get_enabled_languages | harbor/adapters/registry.py | unknown | unknown | ⚪ Missing | — |
...
| harbor.adapters.registry.AdapterRegistry.is_enabled | harbor/adapters/registry.py | unknown | unknown | ⚪ Missing | — |
| harbor.adapters.base.ContractSubject.make_target_id | harbor/adapters/base.py | unknown | unknown | ⚪ Missing | — |
...
| harbor.adapters.base.LanguageAdapter.parse_file | harbor/adapters/base.py | unknown | unknown | ⚪ Missing | — |

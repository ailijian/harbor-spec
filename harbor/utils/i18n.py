...
MESSAGES: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "cli.docs.changed.none": "No changed modules detected. L2 README files are up to date.",
        "cli.docs.changed.found": "Changed modules detected:",
        "cli.docs.all.none": "No indexed modules found. Nothing to generate.",
        "cli.docs.all.found": "Generating L2 README for all indexed modules:",
        "cli.docs.mode_conflict": "--module, --changed, and --all are mutually exclusive.",
        "cli.docs.preview_only": "Preview only. Use --write to update files.",
        "cli.docs.updated": "Updated:",
        "cli.project.structure.title": "Project structure view:",
        "cli.project.structure.preview_only": "Preview only. Use --write to update docs/harbor/project-structure.md.",
        ...
        "cli.module.seal.preview_only": "Preview only. Use --write to update module capsule files.",
        ...
        "cli.module.seal.batch.preview_only": "Preview only. Use --write to update module capsule files.",
        ...
        "cli.module.promote_skill.references": "This skill is a thin entrypoint. It references:",
    ...
    "zh": {
        ...
        "cli.docs.changed.none": "未检测到变更模块。L2 README 已是最新。",
        "cli.docs.changed.found": "检测到变更模块：",
        "cli.docs.all.none": "未发现可生成的已索引模块。",
        "cli.docs.all.found": "正在为全部已索引模块生成 L2 README：",
        "cli.docs.mode_conflict": "--module、--changed 与 --all 互斥，只能选择一种模式。",
        "cli.docs.preview_only": "仅预览。使用 --write 写入文件。",
        "cli.docs.updated": "已更新：",
        "cli.project.structure.title": "项目结构视图：",
        "cli.project.structure.preview_only": "仅预览。使用 --write 更新 docs/harbor/project-structure.md。",
        ...
        "cli.module.seal.preview_only": "仅预览。使用 --write 更新模块胶囊文件。",
        ...
        "cli.module.seal.batch.preview_only": "仅预览。使用 --write 更新模块胶囊文件。",
        ...
        "cli.module.promote_skill.references": "该 Skill 是薄入口，引用以下 capsule：",
